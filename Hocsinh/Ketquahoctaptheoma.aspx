<%@ Page Title="" Language="C#" MasterPageFile="~/Hocsinh/Hocsinh1.master" AutoEventWireup="true" CodeFile="Ketquahoctaptheoma.aspx.cs" Inherits="Hocsinh_Default2" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<p class="text1">Tra cứu điểm theo mã học sinh</p>
<hr />
...
<br />
<asp:GridView ID="gridBangDiem"  style="width:95%; margin:30px auto;" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical">
        <AlternatingRowStyle BackColor="#DCDCDC" />
        <Columns>
            <asp:BoundField DataField="MaMonHoc" HeaderText="Môn Học" />
